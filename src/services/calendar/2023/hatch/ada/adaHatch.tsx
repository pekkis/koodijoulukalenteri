...
const adaHatch: HatchDataWithoutDay = {
  ...
  image: {
    src: ada,
    alt: "Ada Lovelace istumassa ikkunalla läppärinsä kanssa vuonna 1843. Hän kirjoittaa maailman ensimmäistä tietokoneohjelmaa. Ikkunasta näkyy viktoriaaninen Lontoo."
  },
  content: [
    {
      type: "markdown",
