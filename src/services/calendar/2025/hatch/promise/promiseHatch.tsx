...
Vaikken näitä kirjastoja kaipaakaan kuin nostalgiamielessä, niissä oli puolensa - selaimen omalla promisella on kestänyt vuosikymmenen verran saavuttaa käyttömukavuuden taso, joka parhaisiin custom-kirjastoihin aikanaan oli leivottu sisään.

Tuoreimmat parannukset, vuoden 2024 [Promise.withResolvers](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/withResolvers) ja vuoden 2025 [Promise.try](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/try) ovat olleet sellaisia, että arkikoodissanikin on ollut niille käyttöä!
`
    }
  ]
};
